...
class GetCnCodeInformationConnector @Inject()(val http: HttpClient,
                                              config: AppConfig) extends ReferenceDataHttpParser[CnCodeInformationResponse]{

  override implicit val reads: Reads[CnCodeInformationResponse] = CnCodeInformationResponse.reads
