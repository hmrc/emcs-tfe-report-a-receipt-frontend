...
import models.nrs.{IdentityData, NRSPayload, ReportReceiptNRSSubmission}
...
class NRSBrokerService @Inject()(brokerConnector: NRSBrokerConnector,
  ...
  def submitPayload(submission: SubmitReportOfReceiptModel, ern: String)
    ...
    val submissionAsString = Json.stringify(Json.toJson(ReportReceiptNRSSubmission(ern, submission)))
