...
object AddMoreInformationHelper {
  ...
  def titleKey()(implicit request: DataRequest[_]): String =
    s"addMoreInformation${infix()}.title"

  def headingKey()(implicit request: DataRequest[_]): String =
    s"addMoreInformation${infix()}.heading"
