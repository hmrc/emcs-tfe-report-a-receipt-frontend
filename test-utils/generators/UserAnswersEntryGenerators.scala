...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryItemShortageOrExcessUserAnswersEntry: Arbitrary[(ItemShortageOrExcessPage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[ItemShortageOrExcessPage.type]
