...
class ChooseGiveReasonItemDamagedControllerSpec extends SpecBase with MockUserAnswersService {
  ...
  "ChooseGiveReasonItemDamaged Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, chooseGiveReasonItemDamagedRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, chooseGiveReasonItemDamagedRoute)
