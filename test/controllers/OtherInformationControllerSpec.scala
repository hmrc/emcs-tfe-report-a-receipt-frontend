...
class OtherInformationControllerSpec extends SpecBase with JsonOptionFormatter with MockUserAnswersService {
  ...
  lazy val otherInformationRoute: String = routes.OtherInformationController.onPageLoad(testErn, testArc, NormalMode).url
  lazy val otherInformationSubmitAction: Call = routes.OtherInformationController.onSubmit(testErn, testArc, NormalMode)

  val (page, url, submitAction) = (OtherInformationPage, otherInformationRoute, otherInformationSubmitAction)
