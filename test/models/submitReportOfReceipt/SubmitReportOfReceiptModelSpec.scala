  ...
  "SubmitReportOfReceiptModel" - {
    ...
    "calling .apply(_: movementDetails)(_: UserAnswers)" - {
      ...
      "must construct from UserAnswers correctly" - {
        ...
        "have the correct deliveryplace and destingation office for XI trader with XI delivery place" in {
        ...
        "have the correct deliveryplace and destingation office for XI trader with no delivery place" in {
